...
import { Menu, X, ChevronDown, Package, FileText, Phone, Palette, UserPlus, User, ShoppingBag, ShoppingCart, TreePalm, Tag } from 'lucide-react';
...
const LayoutBackend = () => {
    ...
    const menuItems = [
        ...
        { name: 'Thương hiệu', icon: Tag, path: '/admin/brand' },
