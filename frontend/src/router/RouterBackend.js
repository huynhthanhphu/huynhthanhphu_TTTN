...
import BrandList from "../pages/backend/Brand/List";
import BrandTrashList from "../pages/backend/Brand/Trash";
import BrandUpdate from "../pages/backend/Brand/Update";
import BrandCreate from "../pages/backend/Brand/Create";
...
const RouterBackend = [
    ...
    { path: '/admin/brand/trash', element: <BrandTrashList /> },
    { path: '/admin/brand/create', element: <BrandCreate /> },
    { path: '/admin/brand/update/:id', element: <BrandUpdate /> },
    // { path: '/admin/brand/detail/:id', element: <BrandDetail /> },
    // Product
