...
const Cart = () => {
    ...
    const fetchCartItems = async () => {
        try {
            ...
            const user = AuthService.getCurrentUser(); // Giả sử bạn có hàm này
    ...
    const calculateTotals = (items) => {
        ...
        const shippingCost = subtotalAmount > 500000 ? 0 : 30000;
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="w-full lg:w-2/3">
                        <div className="bg-white border border-gray-200 rounded-sm">
                            ...
                            {cartItems.map(item => {
                                ...
                                return (
                                    <div key={item.id}
                                        className="flex flex-col md:flex-row border-b border-gray-200 p-4 items-center"
                                    >
                    ...
                    <div className="w-full lg:w-1/3">
                        <div className="bg-white border border-gray-200 rounded-sm p-6">
                            ...
                            <button
                                className="w-full bg-red-600 text-white py-3 mt-4 hover:bg-red-700"
