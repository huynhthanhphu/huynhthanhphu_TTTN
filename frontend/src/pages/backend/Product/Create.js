        ...
        const fetchBrands = async () => {
            try {
                ...
                if (brandsResponse.data.length > 0) {
                    setForm(prev => ({ ...prev, brandId: brandsResponse.data[0].id }));
                }
            } catch (err) {
...
// Kiểm tra dữ liệu formData gửi đi
        ...
        <div className="container mx-auto mt-8 px-4 font-mono">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-xl font-mono font-medium text-gray-800">
                    <span className="border-b-2 border-indigo-500 pb-1">Thêm Sản phẩm mới</span>
                </h1>
                <button
